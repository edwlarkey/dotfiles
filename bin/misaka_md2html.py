...
example installation (note the use of the python 3 specific pip):
    pip-3.2 install misaka Jinja2 pygments mistune
...
if __name__ == '__main__':
    ...
    parser.add_argument("template_path", help="The template_path (with absolute path)")
    parser.add_argument("template_name", help="template_name (with absolute path)")
    parser.add_argument("template_ext", help="template_ext (with absolute path)")
    parser.add_argument("subdir", help="subdir (with absolute path)")
    ...
    template_file = os.path.join(ns.template_path, '{0}{1}'.format(ns.template_name, ns.template_ext))
